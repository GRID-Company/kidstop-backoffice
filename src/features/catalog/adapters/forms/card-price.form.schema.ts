...
export const cardPriceFormSchema = z
  .object({
    ...
    buyPrice: z.number().min(MIN_PRICE, 'El precio de compra debe ser mayor o igual a 0'),
    sellPrice: z.number().min(MIN_PRICE, 'El precio de venta debe ser mayor o igual a 0'),
  })
