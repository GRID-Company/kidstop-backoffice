...
const PARCHMENT = {
  ...
  vignette:
    'inset 0 0 80px rgba(80,40,10,0.25), inset 0 0 160px rgba(80,40,10,0.1)',
  ctaBg:
    'linear-gradient(180deg, rgba(139,90,43,0.05) 0%, rgba(139,90,43,0.18) 100%)',
} as const;
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        boxShadow:
          'inset 0 1px 0 rgba(255,255,255,0.4), 0 3px 8px rgba(0,0,0,0.12)',
      }}
    >
      <span
      ...
      <div className='flex min-w-0 flex-1 flex-col gap-1'>
        ...
        {item.notes && (
          <span className='truncate text-sm text-amber-700/60 italic'>
            {item.notes}
          </span>
        )}
      </div>
  ...
  return (
    <div className='flex flex-col items-center justify-center gap-4 py-20 text-amber-700/50'>
      ...
      <p className='text-base'>
        Activa cartas en la lista para verlas en el preview
      </p>
    </div>
  );
}

export default function MostWantedPreview({
  items,
  selectedTCG,
  ...
  return (
    <div className='border-default-200 bg-default-50 flex flex-col gap-4 rounded-2xl border p-5'>
      ...
      >
        ...
        <div className='relative z-20 flex flex-col items-center gap-4 px-8 pt-10 pb-4'>
          <motion.div
          ...
          <h2
            className='mw-shimmer-title text-4xl font-black tracking-[0.2em] text-amber-950 uppercase'
        ...
        >
          <motion.p
            className='text-xl font-black tracking-wider text-amber-950 uppercase'
