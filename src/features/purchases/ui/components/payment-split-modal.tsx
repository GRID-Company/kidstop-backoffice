...
import {
  usePaymentSplitForm,
  PaymentSplitFormData,
} from '../../adapters/forms/use-payment-split-form';
        ...
        <DrawerBody className='flex flex-col gap-6'>
          <div className='bg-default-50 flex flex-col gap-3 rounded-lg p-4'>
            <div className='flex items-center justify-between'>
              <span className='text-default-500 text-sm'>Total de compra</span>
          ...
          >
            ...
            {fields.map((field, index) => (
              <div
                key={field.id}
                className='border-default-200 flex flex-col gap-3 rounded-lg border p-4'
              >
                <div className='flex items-center justify-between'>
                  <Chip
                    size='sm'
