  ...
  return (
    <div className='flex flex-col gap-4'>
      <div className='flex items-center gap-2'>
        <Icon icon='lucide:clock' className='text-accent text-lg' />
          ...
          <div key={day} className='flex items-center gap-4'>
            ...
            {isOpen ? (
              <div className='flex items-center gap-2'>
                ...
                />
                <span className='text-default-500 text-sm'>a</span>
                <OverrideInput
                  type='time'
                  size='sm'
                  className='w-36'
              ...
              <span className='text-default-400 text-sm'>Cerrado</span>
            )}
          </div>
        );
      })}
...
export default function OperatingHoursSection(
  props: OperatingHoursSectionProps
) {
  return (
