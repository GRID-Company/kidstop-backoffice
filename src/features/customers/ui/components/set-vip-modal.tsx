      ...
      <DrawerContent>
        ...
        <DrawerBody className='flex flex-col gap-6'>
          ...
          <div className='flex flex-col gap-3'>
            ...
            <div className='bg-default-50 grid grid-cols-2 gap-4 rounded-lg p-4 text-sm'>
          ...
          <div className='bg-default-50 flex items-center gap-3 rounded-lg p-4'>
            <Icon
              icon={
                isVip ? 'lucide:arrow-down-circle' : 'lucide:arrow-up-circle'
              }
              className={`text-2xl ${isVip ? 'text-default-500' : 'text-warning'}`}
            />
            <div className='flex flex-col gap-0.5'>
              <span className='text-sm font-semibold'>Cambio de tipo</span>
